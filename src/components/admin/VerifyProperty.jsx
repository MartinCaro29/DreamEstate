...
const VerifyProperty = () => {
    ...
    const fetchProperty = async () => {
        try {
            ...
            if (propertyData.image) {
                const imageUrl = propertyData.image.startsWith('/images')
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formDataToSend.append('status', 'ne shitje');
...
<Navigation/>
            <div className="w-100 form-background-sell">
                <Container className="py-4 form-container">
                    <div className="mt-3">
                        <Header name={'Verifiko pronen'} ></Header>
                    </div>
                        ...
                        <Form onSubmit={handleSubmit}>
                            <Row className="g-4">
                                ...
                                <Col xs={12} className="mt-4 d-flex justify-content-center gap-3">
                                    ...
                                    >
                                        {isSubmitting ? 'Duke verifikuar...' : 'Verifiko pronën'}
                                    </Button>
                                </Col>
                            </Row>
                        </Form>
